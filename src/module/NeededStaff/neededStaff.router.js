...
router.get("/:id", auth(USER_ROLE.admin), getSingleNeededStaff); // Assuming you want to get a staff member by ID
router.put("/:id", auth(USER_ROLE.admin), updateNeededStaff); // Assuming you want to update a staff member by ID
router.delete("/:id", auth(USER_ROLE.admin), deleteNeededStaff); // Assuming you want to delete a staff member by ID
